...
execute at @e[type=player,gamemode=!creative,gamemode=!spectator] as @e[type=marker,tag=boss_husk.spawn_anchor,tag=prepared,distance=..5] at @s run function tbb:tbb/anchor/spawn_boss
